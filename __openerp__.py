...
##############################################################################
#
#    cbk_hide_commercial_agent: Hide Commercial Agent
...
{
    'name': 'Hide Commercial Agent',
    'version': '0.1',
    'author': 'Codeback Software',
    'summary': 'Hide Commercial Agent',
    'description' : 'Module to hide the commercial agent field in the partner form',
